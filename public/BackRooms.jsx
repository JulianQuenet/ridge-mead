  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Sketchfab_model004" position={[-24.039, 0.089, 8.697]} rotation={[3.137, -0.595, -1.648]} scale={[0.015, 0.006, 0.013]}>
          <group name="23b25ea92bf442208756796bdc261936fbx" rotation={[Math.PI / 2, 0, 0]}>
            <group name="RootNode001" position={[0, 0, -0.001]}>
              <group name="crowbar" position={[0, 0, -0.001]} scale={100} />
            </group>
          </group>
        </group>
        ...
        <mesh name="Plane" geometry={nodes.Plane.geometry} material={materials.top} position={[-5.015, 3.743, 45.046]} scale={[20.123, 2.012, 20.123]} />
        <mesh name="Plane001" geometry={nodes.Plane001.geometry} material={materials.floor} position={[-7.963, 0, 55.286]} scale={[22.5, 1, 13.174]} />
        <mesh name="Plane002" geometry={nodes.Plane002.geometry} material={materials.floor} position={[-7.963, 0, 28.94]} scale={[22.5, 1, 13.174]} />
      </group>
    </group>
  )
}
