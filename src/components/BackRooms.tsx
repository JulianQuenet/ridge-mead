 ...
 useEffect(()=>{
  ...
  return (
    <group dispose={null}>
      ...
      {/* body bags */}
      { door && <group position={[0.61, 0.111, 55.092]} rotation={[-Math.PI / 2, 0, -0.006]} scale={[0.005, 0.004, 0.005]}>
     ...
     {/* chair and board */}
      ...
      {/* the door */}
      { door && <group position={[1.75, 1.532, 56.361]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={[-0.039, -0.016, -0.013]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
        <mesh>
