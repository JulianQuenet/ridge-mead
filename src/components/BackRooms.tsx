  ...
  return (
    ...
    <group position={[0.61, 0.111, 55.092]} rotation={[-Math.PI / 2, 0, -0.006]} scale={[0.005, 0.004, 0.005]}>
      <group rotation={[Math.PI / 2, 0, 0]}>
        ...
        <mesh geometry={nodes.defaultMaterial003.geometry} material={materials['cl_body_mat.002']} position={[-460, 66.507, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
        <mesh geometry={nodes.defaultMaterial.geometry} material={materials['cl_body_mat.002']} position={[600, 0, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
      </group>
    </group>
    <group rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        <group position={[0, 0, 0.001]}>
          <group position={[0, 5, 175.001]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            <mesh geometry={nodes.Cube003_Screen_0.geometry} material={materials['Screen.003']} />
    ...
    <mesh geometry={nodes.P_ceiling_2x2_2001_Material_0002.geometry} material={materials['ceiling.002']} position={[-17.855, 3.891, 30.695]} rotation={[-Math.PI / 2, 0, 0]} scale={[2.337, 2.693, 1]} />
