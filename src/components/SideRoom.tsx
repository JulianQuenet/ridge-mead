...
export function SideRoom(props: triggerProps) {
  ...
  return (
    <group dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={[0.02, 0.017, 0.015]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh
            ...
            material={materials[sense]}
            position={[493, 23, 1965]}
            rotation={[0, -Math.PI / 2, 0]}
            scale={[1.247, 1, 1]}
          />
        </group>
      ...
      <group
        position={[4.3, 3.611, 34.363]}
        rotation={[-Math.PI / 2, 0.313, 1.561]}
        scale={[0.26, 0.349, 0.346]}
      >
        <group rotation={[Math.PI / 2, 0, 0]}>
          <mesh
          ...
          <mesh
            ...
            material={materials["Camera_Plastic.001"]}
          />
        </group>
      </group>
